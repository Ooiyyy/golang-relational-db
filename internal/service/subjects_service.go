...
// constructor
func NewSubjectsService(repo repository.SubjectsCepository, teacherRepo repository.TeacherRepository) *SubjectsService {
	return &SubjectsService{repo: repo, teacherRepo: teacherRepo}
}
