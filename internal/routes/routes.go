...
func SetupRouter(authHandler *handler.AuthHandler, todoHandler *handler.TodoHandler, subjectHandler *handler.SubjectHandler, scoreHandler *handler.ScoreHandler, jwtSecret string) *gin.Engine {
